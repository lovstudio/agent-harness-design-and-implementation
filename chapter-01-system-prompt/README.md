...
![Codex：一位有主体感的同事](assets/agent-harness-cards/codex.png)
...
![Claude Code：一名严谨的工程师](assets/agent-harness-cards/claude-code.png)
...
![Pi：请叫我没有感情的杀手](assets/agent-harness-cards/pi.png)
...
![DSH：您自个儿爱咋滴咋滴](assets/agent-harness-cards/dsh.png)
...
![四种 Agent Harness 的 System Prompt 五维雷达图](assets/agent-harness-cards/agent-harness-radar.png)
